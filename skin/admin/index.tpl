...
{block name="article:content"}
                            ...
                            <form id="edit_config" action="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&amp;action=edit&edit={$hcconfig.id_config}" method="post" class="validate_form add_form col-ph-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div id="hc_type" class="btn-group">
                                        ...
                                        <label class="btn {if $hcconfig.type_hc === 'category'}btn-main-theme{else}btn-default{/if}">
                                            <input type="radio" name="hcconfig[type_hc]" value="category" id="hc_cat" autocomplete="off"{if $hcconfig.type_hc === 'category'} checked{/if}> {#hc_category#}
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
    ...
    {include file="modal/delete.tpl" data_type='product' title={#modal_delete_title#|ucfirst} info_text=true delete_message={#modal_delete_message#}}
